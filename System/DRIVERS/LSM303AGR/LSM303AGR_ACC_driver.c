...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_STATUS_REG_AUX, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT_COUNTER_REG, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_WHO_AM_I_REG, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_TEMP_EN_bits(LSM303AGR_ACC_TEMP_EN_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TEMP_CFG_REG, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_TEMP_EN_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_TEMP_CFG_REG, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TEMP_CFG_REG, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_XEN(LSM303AGR_ACC_XEN_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG1, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_XEN_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG1, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG1, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_hpf_aoi_en_int1(LSM303AGR_ACC_HPIS1_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG2, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_HPIS1_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG2, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG2, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_FIFO_Overrun_on_INT1(LSM303AGR_ACC_I1_OVERRUN_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG3, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_I1_OVERRUN_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG3, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG3, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_SPI_mode(LSM303AGR_ACC_SIM_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG4, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_SIM_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG4, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG4, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_4D_on_INT2(LSM303AGR_ACC_D4D_INT2_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG5, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_D4D_INT2_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG5, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG5, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_IntActive(LSM303AGR_ACC_H_LACTIVE_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG6, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_H_LACTIVE_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CTRL_REG6, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CTRL_REG6, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_ReferenceVal(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_REFERENCE, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_REF_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_REFERENCE, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_REFERENCE, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_STATUS_REG2, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_FifoThreshold(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_FIFO_CTRL_REG, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_FTH_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_FIFO_CTRL_REG, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_FIFO_CTRL_REG, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_FIFO_SRC_REG, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int1EnXLo(LSM303AGR_ACC_XLIE_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_CFG, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_XLIE_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT1_CFG, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_CFG, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int2EnXLo(LSM303AGR_ACC_XLIE_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_CFG, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_XLIE_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT2_CFG, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_CFG, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_SOURCE, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_SOURCE, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int1_Threshold(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_THS, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_THS_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT1_THS, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_THS, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int2_Threshold(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_THS, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_THS_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT2_THS, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_THS, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int1_Duration(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_DURATION, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_D_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT1_DURATION, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT1_DURATION, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_Int2_Duration(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_DURATION, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_D_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_INT2_DURATION, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_INT2_DURATION, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_XSingle(LSM303AGR_ACC_XS_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CLICK_CFG, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_XS_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CLICK_CFG, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CLICK_CFG, (u8_t *)value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CLICK_SRC, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_ClickThreshold(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CLICK_THS, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_THS_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_CLICK_THS, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_CLICK_THS, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_ClickTimeLimit(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_LIMIT, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_TLI_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_TIME_LIMIT, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_LIMIT, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_ClickTimeLatency(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_LATENCY, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_TLA_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_TIME_LATENCY, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_LATENCY, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t  LSM303AGR_ACC_W_ClickTimeWindow(u8_t newValue)
{
  ...
  if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_WINDOW, &value) )
    return MEMS_ERROR;

  value &= ~LSM303AGR_ACC_TW_MASK; 
  value |= newValue;
  
  if( !LSM303AGR_ACC_WriteReg(LSM303AGR_ACC_TIME_WINDOW, value) )
    return MEMS_ERROR;
...
{
 if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_TIME_WINDOW, (u8_t *)value) )
    return MEMS_ERROR;
...
status_t LSM303AGR_ACC_Get_Voltage_ADC(u8_t *buff) 
{
  ...
  for (i=0; i<3;i++ ) 
  {
	for (j=0; j<numberOfByteForDimension;j++ )
	{	
		if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_OUT_ADC1_L+k, &buff[k]))
		  return MEMS_ERROR;
		k++;	
	}
  }
...
status_t LSM303AGR_ACC_Get_Raw_Acceleration(u8_t *buff) 
{
  ...
  for (i=0; i<3;i++ ) 
  {
	for (j=0; j<numberOfByteForDimension;j++ )
	{	
		if( !LSM303AGR_ACC_ReadReg(LSM303AGR_ACC_OUT_X_L+k, &buff[k]))
		  return MEMS_ERROR;
		k++;	
	}
  }
...
status_t LSM303AGR_ACC_Get_Acceleration(int *buff)
{
  ...
  if (lp == LSM303AGR_ACC_LPEN_DISABLED && hr == LSM303AGR_ACC_HR_DISABLED) {
    /* op mode is Normal 10-bit */
    op_mode = 1;
    shift = 6;
 } else
  if (lp == LSM303AGR_ACC_LPEN_DISABLED && hr == LSM303AGR_ACC_HR_ENABLED) {
